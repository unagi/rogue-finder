"""Japanese translation catalog for rogue-finder GUI."""
...
TRANSLATIONS: dict[str, str] = {
    ...
    "table_copy_cell": "セルをコピー",
    "table_copy_row_tsv": "行をコピー (TSV)",
    "advanced_select_label": "高精度対象",
    "safety_select_label": "安全診断対象",
    "select_all": "全選択",
    "run_advanced_button": "高精度実行",
    "run_advanced_with_os_button": "高精度 + OS 判定",
    "run_all_ports_button": "全ポート実行",
    "run_all_ports_with_os_button": "全ポート + OS 判定",
    ...
    "all_ports_missing_body": "全ポートスキャンを行うホストを選択してください。",
    "advanced_running_status": "高精度ディスカバリを実行中...",
    "advanced_running_status_eta": "高精度ディスカバリを実行中 (残り約 {eta})",
    "all_ports_running_status": "全ポートスキャンを実行中...",
    "all_ports_running_status_eta": "全ポートスキャンを実行中 (残り約 {eta})",
    ...
    "diagnostics_status/not_started": "未実行",
    "diagnostics_status/running": "実行中",
    "diagnostics_status/completed": "完了",
    "diagnostics_status/failed": "失敗",
    ...
    "storage_scope/config": "設定",
    "storage_scope/state": "ステート",
    "storage_action/write": "書き込み",
