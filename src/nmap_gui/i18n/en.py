...
TRANSLATIONS: dict[str, str] = {
    ...
    "table_copy_cell": "Copy Cell",
    "table_copy_row_tsv": "Copy Row (TSV)",
    ...
    "run_all_ports_button": "Run All Ports",
    "run_all_ports_with_os_button": "Run All Ports + OS",
    ...
    "all_ports_missing_body": "Select at least one host for an all-ports scan.",
    "advanced_running_status": "Running advanced discovery...",
    "advanced_running_status_eta": "Running advanced discovery (~ETA {eta})",
    "all_ports_running_status": "Running all-ports scan...",
    "all_ports_running_status_eta": "Running all-ports scan (~ETA {eta})",
